...
export default function Categories() {
  ...
  return (
    <main>
      <div ref={ref} className=" h-auto w-screen px-4 md:px-28 py-6 bg-white bg-cover bg-center">
      ...
      <div className="grid grid-cols-2 grid-rows-10 md:grid-cols-6 md:grid-rows-6  gap-3 h-full">
        <motion.div variants={cardVariants} initial="hidden" animate={inView ? "show" : "hidden"} custom="left" className="h-[150px] md:h-[300px] col-span-2 row-span-2 md:col-span-3 md:row-span-3 rounded-2xl bg-[url('/assets/pdcategory.jpg')] bg-cover bg-center shadow-custom">
        <Link to="/personal-development" className="relative w-full h-full">
        ...
        <motion.div variants={cardVariants} initial="hidden" animate={inView ? "show" : "hidden"} custom="bottom"  className="h-[150px] md:h-[250px] col-span-2 row-span-2 row-start-5 md:col-span-2 md:row-span-3 md:row-start-4 rounded-2xl bg-[url('/assets/fantasy.jpg')] bg-cover bg-center shadow-custom">
        <Link to="/fantasy" className="relative w-full h-full">
          <div className="relative w-full h-full bg-black/50 rounded-2xl group cursor-pointer">
            <button className="absolute top-2 right-2 inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-white">
              <div className="rotate-0 transition duration-300 group-hover:-rotate-45">
                <svg
        ...
        <motion.div variants={cardVariants} initial="hidden" animate={inView ? "show" : "hidden"} custom="bottom" className="h-[150px] md:h-[250px] col-span-2 row-span-2 row-start-7 md:col-span-2 md:row-span-3 md:col-start-3 md:row-start-4 rounded-2xl bg-[url('/assets/romance.jpg')] bg-cover bg-center shadow-custom">
        <Link to="/romance" className="relative w-full h-full">
          <div className="relative w-full h-full bg-black/50 rounded-2xl group cursor-pointer">
            <button className="absolute top-2 right-2 inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-white">
              <div className="rotate-0 transition duration-300 group-hover:-rotate-45">
                <svg
        ...
        <motion.div variants={cardVariants} initial="hidden" animate={inView ? "show" : "hidden"} custom="bottom" className="h-[150px] md:h-[250px] col-span-2 row-span-2 row-start-9 md:col-span-2 md:row-span-3 md:col-start-5 md:row-start-4 rounded-2xl bg-[url('/assets/humor.jpg')] bg-cover bg-center shadow-custom">
        <Link to="/humour" className="relative w-full h-full">
          <div className="relative w-full h-full bg-black/50 rounded-2xl group cursor-pointer">
            <button className="absolute top-2 right-2 inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-white">
              <div className="rotate-0 transition duration-300 group-hover:-rotate-45">
                <svg
